...
namespace farm_house.Models
{
    public class UserModel
    {
        ...
        public string Insert_Booking(int id, int user_id, int farmhouse_id, string checkin_date , string checkout_date , string daytime_slot, string status , string cancle)
        {
            var query_test = "insert into [dbo].[farmhouse_bookings](user_id,farmhouse_id,checkin_date,checkout_date,daytime_slot,status,cancle)values('" + user_id + "','" + farmhouse_id + "','" + checkin_date + "','" + checkout_date + "','" + daytime_slot + " ','" + status + " ','" + cancle + " ')";
            return query_test;
